...
export function DeleteModal({ isOpen, onClose, onConfirm, projectName, darkMode }: DeleteModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div 
        className="relative w-full max-w-sm border shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200"
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b" style={{ borderColor }}>
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.2em]" style={{ color: textColor }}>
              Delete Project
            </span>
          </div>
          <button 
        ...
        {/* Body */}
        <div className="p-8">
          <p className="text-[11px] leading-relaxed tracking-wide" style={{ color: mutedText }}>
            Are you sure you want to delete <span className="font-bold" style={{ color: textColor }}>"{projectName}"</span>? This action cannot be undone and all pixel data will be permanently removed.
          </p>
        </div>
        ...
        <div className="flex border-t" style={{ borderColor }}>
          <button
            onClick={onClose}
            className="flex-1 py-4 text-[10px] font-bold uppercase tracking-widest transition-colors hover:bg-accent"
